...
Em todos os exemplos deste material serão usados os estilos \pyline{'seaborn-v0_8-whitegrid'}, \pyline{'seaborn-v0_8-paper'} e \\\pyline{'seaborn-v0_8-muted'}, nessa ordem, além de algumas \href{https://matplotlib.org/users/customizing.html}{configurações adicionais}. Tudo está presente no código \ref{code:basico:format}.
