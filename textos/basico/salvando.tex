A interface \pyplot também ajuda na hora de salvar os gráficos em imagens, com a função \href{https://matplotlib.org/3.1.0/api/_as_gen/matplotlib.pyplot.savefig.html}{\pyline{savefig}}. Essa função reconhece o tipo do arquivo pela extensão e já vem com várias opções desde o início. Os tipos mais importantes normalmente são \texttt{PNG} e \texttt{PDF}, que podem ser criados seguindo os códigos \ref{code:basico:png} e  \ref{code:basico:pdf}. Para o \texttt{PNG}, também existe a opção de controlar a resolução pelo \texttt{DPI} da imagem, com o argumento \pyline{dpi}.
