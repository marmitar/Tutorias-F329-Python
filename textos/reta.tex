...
\subsection{Dados Pontuais}
    ...
    Para apresentar os dados coletados, a melhor opção é a função \href{https://matplotlib.org/3.1.0/api/_as_gen/matplotlib.pyplot.scatter.html}{\pyline{scatter}} do \pyplot, que recebe uma lista de valores de $x$ e outra lista de $y$ como argumentos.
